...
public class RestRegistrationController {
	...
	//http://localhost8080/api/reg?id=2
	@PutMapping
	...
	public ResponseEntity<?> getRegistrationById(@PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Registration not Found wth id : "+id,HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
}
